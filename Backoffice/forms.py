...
from .models import Equipements, Directions, Raccordement_ligne_electrique, Client, Emplacement_equip, Emplacement_raccord, Agent
...
class Raccordement_ligne_electriqueForm(forms.ModelForm):
    class Meta:
        model = Raccordement_ligne_electrique
        fields = '__all__'
...
class Emplacement_EquipForm(forms.ModelForm):
    class Meta:
        model = Emplacement_equip
        fields = '__all__'


class Emplacement_raccordForm(forms.ModelForm):
    class Meta:
        model = Emplacement_raccord
        fields = '__all__'
